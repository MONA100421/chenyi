...
- **[Spark Data Extraction System](https://github.com/MONA100421/TEAM_03_DSCI550_HW_EXTRACT)**  
  Designed a Python + Spark pipeline for large-scale unstructured data.  
  Achieved **>90% clean data accuracy**, optimized parsing with regex + batch processing.  

- **[Interactive Data Visualization Dashboard](https://github.com/MONA100421/TEAM_03_DSCI550_HW_DATAVIS)**  
  Developed dashboards with **Plotly/Dash** to explore million-scale datasets.  
  Added filtering & drill-down features for business decision-making.  
